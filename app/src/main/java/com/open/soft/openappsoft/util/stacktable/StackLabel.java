package com.open.soft.openappsoft.util.stacktable;
...
import com.open.soft.openappsoft.util.stacktable.interfaces.OnLabelClickListener;
...
public class StackLabel extends ViewGroup {
    ...
    private void loadAttrs(Context context, AttributeSet attrs) {
        try {
            ...
            textSize = typedArray.getDimensionPixelOffset(R.styleable.StackLabel_textColor1, textSize);
