...
//        setData(2, 50);
    ...
    private void initView() {
        ...
        ivQueryCondition = (ImageView) findViewById(R.id.iv_query_condition);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.iv_query_condition) {
    ...
    private void showSelectTimeDialog() {
        ...
        DatePicker startTime = (DatePicker) dateSelectView.findViewById(R.id.date_picker_start_time);
        DatePicker endTime = (DatePicker) dateSelectView.findViewById(R.id.date_picker_end_time);
