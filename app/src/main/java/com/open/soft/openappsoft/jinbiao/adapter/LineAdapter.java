...
public class LineAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View view;
		if(convertView == null){
			view = View.inflate(context, R.layout.item_project_jinbiao, null);
			vh = new ViewHolder();
		...
		vh.tvProject.setText(model.name==null?"":model.name);
		vh.tvScanStart.setText( model.ScanStart==null?"":model.ScanStart);
		vh.tvScanEnd.setText(model.ScanEnd==null?"":model.ScanEnd);
		vh.tvPeakWidth.setText( model.CTWidth==null?"":model.CTWidth);
		vh.tvPeakDistance.setText( model.CTDistance==null?"":model.CTDistance);
