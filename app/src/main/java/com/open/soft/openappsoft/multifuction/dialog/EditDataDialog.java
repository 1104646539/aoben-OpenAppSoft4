...
public class EditDataDialog<T> extends Dialog {
    ...
    private void init() {
        ...
        tv_title = (TextView) view.findViewById(R.id.dialog_edit_title);
        tv_hint = (TextView) view.findViewById(R.id.dialog_edit_hint);
        et_content = (EditText) view.findViewById(R.id.dialog_edit_content);
        recyclerView = (RecyclerView) view.findViewById(R.id.dialog_edit_list);
        btn_add = (Button) view.findViewById(R.id.dialog_edit_add);
        btn_del = (Button) view.findViewById(R.id.dialog_edit_del);
        btn_cancel = (Button) view.findViewById(R.id.dialog_edit_cancel);
        btn_change = (Button) view.findViewById(R.id.dialog_edit_change);
//        getWindow().setBackgroundDrawableResource(android.R.color.transparent);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
    }

    public void showDialog(String title,final int type, final DialogSelectAdapter.OnItemClick onItemClick) {
        if (isShowing()) {
            dismiss();
        }
