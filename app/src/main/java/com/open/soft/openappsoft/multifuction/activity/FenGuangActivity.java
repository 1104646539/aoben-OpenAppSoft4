...
import com.open.soft.openappsoft.multifuction.adapter.ProjectDetailAdapter;
...
//        projectList = new Project().findAll();
    ...
    private void initView() {
        ...
        etSampleName = (TextView) findViewById(R.id.et_sample_name);
        etSampleSource = (TextView) findViewById(R.id.et_sample_source);
        etCompare = (TextView) findViewById(R.id.et_compare_value);
        et_sample_weight = (EditText) findViewById(R.id.et_sample_weight);
        etYzl = (TextView) findViewById(R.id.et_yzl);
        etJudge = (TextView) findViewById(R.id.et_judge);
        btnCompare = (Button) findViewById(R.id.btn_compare);
        btnTest = (Button) findViewById(R.id.btn_test);
        btnSave = (Button) findViewById(R.id.btn_save_record);
        et_sample_number = (EditText) findViewById(R.id.et_sample_number);
        btnReturn = (Button) findViewById(R.id.btn_return);
        tvCountDown = (TextView) findViewById(R.id.tv_count_down);
        etCheckedOrg = (TextView) findViewById(R.id.et_checked_org);
...
//                        m_fvalue[i] = (AC - Ac[i] < 0) ? 0.0f : (((AC - Ac[i]) * 100 / AC));
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btn_return) {
            ...
            test();
        } else if (i == R.id.btn_save_record) {
            if (checkResult == null) {
...
//                break;
    ...
    private void showSelectDialog(final TextView v, final int type) {
