...
public class LocationActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        tvState = (TextView) findViewById(R.id.tv_location_state);
        tvJingdu = (TextView) findViewById(R.id.tv_jingdu);
        tvWeidu = (TextView) findViewById(R.id.tv_location_weidu);
        btnStartLocation = (Button) findViewById(R.id.btn_start_location);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btn_return) {
            finish();
        } else if (i == R.id.btn_start_location) {
