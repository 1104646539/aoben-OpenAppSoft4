...
public class DebugActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        btnClearWindow = (Button) findViewById(R.id.btn_clear_window);
        btnReturn = (Button) findViewById(R.id.btn_return);
        btnGetData.setOnClickListener(this);
        btnClearWindow.setOnClickListener(this);
        btnReturn.setOnClickListener(this);
        etStep = (EditText) findViewById(R.id.et_step);
        btnFitStep = (Button) findViewById(R.id.btn_fit_step);
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();
        if (i == R.id.btn_get_data) {
            enableControls(false);
            getData();
        } else if (i == R.id.btn_clear_window) {
            adapter = null;
            lv.setAdapter(null);
        } else if (i == R.id.btn_return) {
            finish();
        } else if (i == R.id.btn_fit_step) {
    ...
    private class DebugDataAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                vh.tv7 = (TextView)convertView.findViewById(R.id.tv7);
                vh.tv8 = (TextView)convertView.findViewById(R.id.tv8);
                vh.tv9 = (TextView)convertView.findViewById(R.id.tv9);
                vh.tv10 = (TextView)convertView.findViewById(R.id.tv10);
                vh.tv11 = (TextView)convertView.findViewById(R.id.tv11);
                vh.tv12 = (TextView)convertView.findViewById(R.id.tv12);
                ...
                vh.iv6 = (ImageView)convertView.findViewById(R.id.iv6);
                vh.iv7 = (ImageView)convertView.findViewById(R.id.iv7);
                vh.iv8 = (ImageView)convertView.findViewById(R.id.iv8);
                vh.iv9 = (ImageView)convertView.findViewById(R.id.iv9);
                vh.iv10 = (ImageView)convertView.findViewById(R.id.iv10);
                vh.iv11 = (ImageView)convertView.findViewById(R.id.iv11);
                vh.iv12 = (ImageView)convertView.findViewById(R.id.iv12);
