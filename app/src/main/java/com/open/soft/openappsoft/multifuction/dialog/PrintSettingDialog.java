...
import com.open.soft.openappsoft.multifuction.adapter.PrintAdapter;
...
public class PrintSettingDialog extends Dialog {
    ...
    private void init() {
        ...
        ll_mu = (LinearLayout) contentView.findViewById(R.id.ll_mu);
        ll_me = (LinearLayout) contentView.findViewById(R.id.ll_me);
        iv_mu = (ImageView) contentView.findViewById(R.id.iv_mu);
        iv_me = (ImageView) contentView.findViewById(R.id.iv_me);
        btn_save = (Button) contentView.findViewById(R.id.btn_save);
        btn_cancel = (Button) contentView.findViewById(R.id.btn_cancel);
        recyclerView = (RecyclerView) contentView.findViewById(R.id.rv_data);
