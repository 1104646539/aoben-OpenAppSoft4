...
import com.open.soft.openappsoft.multifuction.adapter.ProjectAdapter;
...
//        etSingleXlz = findViewById(R.id.et_single_xlz);
        etCardXlz = (EditText) findViewById(R.id.et_card_xlz);
        etProject = (EditText) findViewById(R.id.et_project_name);
        ...
        btnSave = (Button) findViewById(R.id.btn_save_project);
        spn_bochange = (Spinner) findViewById(R.id.spn_bochange);
...
//        ArrayAdapter<CharSequence> adapter = new ArrayAdapter<CharSequence>(this, android.R.layout.simple_list_item_1, Arrays.asList(bochanges));
        ArrayAdapter<CharSequence> adapter = new ArrayAdapter<CharSequence>(this, android.R.layout.simple_list_item_1, new String[]{"535","410","590"});
...
//        }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btn_clear_data) {
            ...
            showDeleteDialog();
        } else if (i == R.id.btn_save_project) {
            updateData();
        } else if (i == R.id.btn_add_data) {
...
//        project.projectName = snp.get(spn_project.getSelectedItemPosition()).projectName;
        project.projectName = et_project.getText().toString();
...
//        project.checker = etChecker.getText().toString().trim();
        ...
        if (project.update(new String[]{ "projectName",  "k","b","bochang","cardXlz"})) {
            if (projectList != null) {
...
//                    spn_project.setSelection(i);
                    et_project.setText(snp.get(i).getName());
                }
            }
        }
    }
