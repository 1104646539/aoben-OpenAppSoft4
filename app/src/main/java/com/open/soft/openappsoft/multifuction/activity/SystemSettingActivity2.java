...
import com.open.soft.openappsoft.multifuction.adapter.DialogSelectAdapter;
import com.open.soft.openappsoft.multifuction.dialog.EditDataDialog;
import com.open.soft.openappsoft.multifuction.dialog.EditURLDialog;
import com.open.soft.openappsoft.multifuction.dialog.PrintSettingDialog;
...
import com.open.soft.openappsoft.multifuction.model.VersionInfo;
...
import com.open.soft.openappsoft.multifuction.view.AutoConintaEditText;
...
//    private Button btnUploadSetting;
    ...
    private AutoConintaEditText et_card_warm_time;
    ...
    private void initView() {
        ...
        et_card_warm_time = (AutoConintaEditText) findViewById(R.id.et_card_warm_time);
        btn_project = (Button) findViewById(R.id.btn_project);
        order_setting = (TextView) findViewById(R.id.order_setting);
        ...
        et_card_warm_time.setOnSave(new AutoConintaEditText.OnSave() {
            ...
            public void Save(String str) {
                if (str.equals("") || str.equals("0")) {
                    Toast.makeText(SystemSettingActivity2.this, "数值不能小于1", Toast.LENGTH_SHORT).show();
                    str = "1";
                    Global.cardWarmTime = 1;
                    et_card_warm_time.setText(Global.cardWarmTime + "s");
                }
...
////                sp.edit().putString(SPResource.KEY_UPLOAD_URL, Global.BASE_URL).commit();
