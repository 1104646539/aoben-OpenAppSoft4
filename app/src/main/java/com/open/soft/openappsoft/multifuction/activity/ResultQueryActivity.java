...
import com.open.soft.openappsoft.multifuction.adapter.CheckResultAdapter;
...
import com.open.soft.openappsoft.multifuction.thread.UploadThread;
...
public class ResultQueryActivity extends Activity implements View.OnClickListener, CheckResultAdapter.onSelectedItemChangedListener {
    ...
    private final static String EXPORT_DIR = "/有机磷和氨基甲酸酯类检测/";
    ...
    private CheckResult selectResultMode;
...
//        checkResult.save(checkResult);
        ...
        lv.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                selectResultMode = resultList.get(position);
            }
...
//            }
    ...
    private void initView() {
        ...
        tvDataCount = (TextView) findViewById(R.id.tv_data_count);
        cbChecker = (CheckBox) findViewById(R.id.cb_checker);
        cbCheckedOrg = (CheckBox) findViewById(R.id.cb_checked_organization);
        cbSampleName = (CheckBox) findViewById(R.id.cb_sample_name);
//        cbSampleNum = findViewById(R.id.cb_sample_num);
        cbUploadState = (CheckBox) findViewById(R.id.cb_upload_state);
        cbSource = (CheckBox) findViewById(R.id.cb_sample_source);
        cbTestTime = (CheckBox) findViewById(R.id.cb_test_time);
        cbResultJudge = (CheckBox) findViewById(R.id.cb_result_judge);

        spnChecker = (Spinner) findViewById(R.id.spn_checker);
        spnResult = (Spinner) findViewById(R.id.spn_result);
        spnCheckedOrg = (Spinner) findViewById(R.id.spn_checked_organization);
        spnSampleName = (Spinner) findViewById(R.id.spn_sample_name);
//        spnSampleNum = findViewById(R.id.spn_sample_num);
        spnUploadState = (Spinner) findViewById(R.id.spn_upload_state);
        spnSampleSource = (Spinner) findViewById(R.id.spn_sample_source);
        spnResultJudge = (Spinner) findViewById(R.id.spn_result_judge);
        ...
        btnExportData = (Button) findViewById(R.id.btn_export_data);
        btnExportData.setOnClickListener(this);
        btnReturn = (Button) findViewById(R.id.btn_return);
        btnReturn.setOnClickListener(this);
        btnClear = (Button) findViewById(R.id.btn_clear_data);
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.btn_clear_data) {
            showClearDialog();
        } else if (i == R.id.btn_delete_data) {
            showDeleteDialog();
            ...
            byte[] data = ToolUtils.assemblePrintData(adapter.getSelectList(),this);

//            String printData = com.open.soft.openappsoft.jinbiao.util.ToolUtils.GetPrintInfo(selectResultMode, this);
            ...
            finish();
        } else if (i == R.id.btn_export_data) {
...
//
        ...
        Collections.addAll(list, selectedResult);
        ...
        try {
            ...
            if (resultList != null) {
                for (int i = 0; i < resultList.size(); i++) {
                    ...
                    sheet.addCell(new Label(4, lineIdx, result.checkedOrganization, defaultCellFormat)); //检测单位名称
...
//                    sheet.addCell(new Label(10, i + 1, result.hasUpload ? "已上传" : "未上传"));
    ...
    private void showEditDialog(final CheckResult result,final int position) {
        if (editDialog == null) {
            initDialog();
        }
        editDialog.show();
    ...
    private void initDialog() {
        ...
        dialog_et_weight = (EditText) view.findViewById(R.id.et_weight);
        dialog_spn_checker = (Spinner) view.findViewById(R.id.spn_checker);
        dialog_spn_sample_unit = (Spinner) view.findViewById(R.id.spn_sample_unit);
        dialog_et_sample_number = (EditText) view.findViewById(R.id.et_sample_number);
        dialog_sample_source = (Spinner) view.findViewById(R.id.spn_sample_source);
        dialog_tv_confirm = (TextView) view.findViewById(R.id.tv_confirm);
        dialog_tv_cancel = (TextView) view.findViewById(R.id.tv_cancel);
    }
