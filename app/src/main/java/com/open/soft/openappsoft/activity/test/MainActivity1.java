package com.open.soft.openappsoft.activity.test;
...
import com.open.soft.openappsoft.jinbiao.location.Utils;
...
//        GT.Game.startGameWindow(this);
        ...
        findViewById(R.id.startAct).setOnClickListener(new View.OnClickListener() {
            @Override
